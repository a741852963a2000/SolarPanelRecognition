...
from ALL_NewVGG16_directMerge import ALL_NewVGG16_directMerge
from DatasetLoader import load_data

def main():
	batchSize = 256
	model = ALL_NewVGG16_directMerge()
	...
	y_pred = model.model.predict(x=(data['PAN'], data['MS'][:,:,:,:3]), batch_size=batchSize, verbose=2)
