...
class MS_NewVGG16():
	...
	def createModel(self):
		input = Input(shape=(15, 15, 4), name='MS_input')
		resize = Lambda(lambda t:tf.image.resize(t, [60, 60], method=tf.image.ResizeMethod.NEAREST_NEIGHBOR), name="MS_resize")(input)
